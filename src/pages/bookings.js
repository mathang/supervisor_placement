export const pageTitle = 'Bookings';
...
function createActionButton(label) {
    ...
    button.setAttribute('aria-label', `${label} scheduling option (coming soon)`);
    return button;
}
...
export function render() {
    ...
    heading.textContent = 'Bookings & Visits';
    ...
    intro.textContent = 'Coordinate site visits, observation windows, and availability with campus partners.';
    ...
    subHeading.textContent = 'Scheduling Shortcuts';
